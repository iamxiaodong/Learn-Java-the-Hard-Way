...
public class ex1
{
	public static void main(String[] args)
	{
		...
		int ci2  = 0 + (int)(Math.random() * colors.length     ); // color for required assignments
		int ad1  = 0 + (int)(Math.random() * adverbs.length    ); // adverb
		...
		String color2   = colors[ci2];
		String adv1      = adverbs[ad1];
