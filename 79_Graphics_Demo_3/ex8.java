...
public class ex8 extends Canvas
{
	...
	// A line is a graphics primitive that connects two points. In Java, to draw a line between two points (x1, y1) and (x2, y2) onto graphics context represented by a Graphicsobject, use the following method: drawLine(int x1, int y1, int x2, int y2)
        ...
        // Change the first "Leander Lions" (the white one) to a different font. Change the blue "Leander Lions" to match it.
		g.setColor(Color.white);
		g.setFont(new Font("Garamond", Font.BOLD+Font.ITALIC , 11));
	...
	{
		JFrame win = new JFrame("ex8: Fonts and Lines");
		win.setSize(800,600);
